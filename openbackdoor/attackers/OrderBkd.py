...
import sys
import os
sys.path.append(r'D:\OpenBackdoor\OrderBkd')
...
class OrderBkd:
    def __init__(
        self, target_label: int = 1, output_path: str = "result_orderbkd", metrics: list = None
    ) -> None:
        self.target_label = target_label
        self.output_path = output_path
        self.metrics = metrics if metrics else []  # 如果没有传入 metrics，则使用空列表
